    ...
    return (
        <div className='flex justify-center items-center'>
            <div>
                ...
                <button className='bg-red-500 w-full m-2 p-2 rounded-lg hover:bg-red-800'>SignIn</button>
                <p>Didn't have account? <Link to='/regestration' className='text-blue-600'>SignUp</Link></p>
                <div className='text-center mt-5'>
                    <p className='text-pink-900'>OR, SignIn with</p>
